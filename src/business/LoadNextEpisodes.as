...
package business
{
	...
	public class LoadNextEpisodes
	{
		static private var instance:LoadNextEpisodes;
		...
		public function LoadNextEpisodes()
		{			
			xmlData = EpisodesDataHandler.getInstance();
		}
		
		static public function getInstance():LoadNextEpisodes
		{
			if (instance == null) instance = new LoadNextEpisodes();
