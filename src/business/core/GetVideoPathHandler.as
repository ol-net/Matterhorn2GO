...
package business.core
{
	...
	public class GetVideoPathHandler
	{
		...
		public function getPathiOSToDownload(data:Object):Array
		{
			var xpathValue:XMLHandler = new XMLHandler();
			
			var object:Array = getVideoPathiOSToDownload("presenter/delivery", "presentation/delivery", data);
			...
			if(xpathValue.getResult(videoPath, data) == "")
			{
				object = getVideoPathiOSToDownload("presentation/delivery", "presenter/delivery", data);
		...
		public function getVideoIOSPath(deliveryFirst:String, deliverySecond:String, data:Object):Array
		{
			...
			//if(xpathValue.getResult(videoPath, data) != "")
			//{
			//	trace("medium-qualito")
				//return [videoPath, videoPathTwo];
		//	}
			
			if(xpathValue.getResult("mediapackage/media/track[mimetype='video/x-flv']/url", data) != "")
			{
				videoPath = "mediapackage/media/track[@type='"+deliveryFirst+"'][tags/tag[2]='medium-quality'][2]/url"
				videoPathTwo = "mediapackage/media/track[@type='"+deliverySecond+"'][tags/tag[2]='medium-quality'][2]/url";
		...
		public function getVideoPathiOSToDownload(deliveryFirst:String, deliverySecond:String, data:Object):Array
		{
			var xpathValue:XMLHandler = new XMLHandler();
