...
package business.datahandler.did
{
	...
	public class DeviceInfoReader extends EventDispatcher 
	{	
		private var fileStream:FileStream;
		
		private var status:String = "nein";
		
		static private var instance:DeviceInfoReader;
		...
		static public function getInstance():DeviceInfoReader 
		{
			if (instance == null) 
			{
				instance = new DeviceInfoReader();
			}
		...
		{ 
			...
			var f:File = File.applicationStorageDirectory.resolvePath("deviceinfo.cfg"); 
